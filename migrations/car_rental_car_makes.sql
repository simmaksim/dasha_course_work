...
CREATE TABLE `car_makes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `car_makes_id_uindex` (`id`),
  UNIQUE KEY `car_makes_name_uindex` (`name`)
...
INSERT INTO `car_makes` VALUES (8,'Audi'),(1,'BMW'),(6,'Ford'),(4,'Honda'),(7,'Hyundai'),(3,'Mercedes'),(2,'Toyota'),(5,'Volkswagen');
